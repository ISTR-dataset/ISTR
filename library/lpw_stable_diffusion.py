...
#     #         self.__init__additional__()
    ...
    def __init__(
        ...
        # 检查 unet 是否被包装为 DistributedDataParallel，取出原始模型
    ...
    def decode_latents(self, latents):
        # # 1x1 卷积将通道数从 5 调整到 4
        # reduction_conv = nn.Conv2d(5, 4, kernel_size=1).to(latents.device)  # 与 latents 在同一设备上
        # latents = reduction_conv(latents)  # 将通道数从 5 减少到 4
