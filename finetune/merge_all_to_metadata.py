...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out_json", type=str, default="", help="Metadata file to output")

    parser.add_argument("--in_json", type=str,
                        help="Input metadata file (if omitted, and the out_json file exists, it will read from the existing out_json file)")

    parser.add_argument("--full_path", action="store_true",
                        help="Use full paths as image keys in the metadata (supports multiple directories)")

    parser.add_argument("--recursive", action="store_true",
                        help="Recursively search for training labels and captions")

    parser.add_argument("--debug", action="store_true", help="Debug mode")

    parser.add_argument("--clean_caption", action="store_true", help="Clean captions and tags in the metadata")
